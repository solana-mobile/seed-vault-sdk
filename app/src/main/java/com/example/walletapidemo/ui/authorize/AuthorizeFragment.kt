...
import com.example.walletapidemo.R
import com.example.walletapidemo.WalletAPIDemoApplication
import com.example.walletapidemo.databinding.FragmentAuthorizeBinding
import com.example.walletapidemo.model.SeedDetails
import kotlinx.coroutines.flow.collect
import kotlinx.coroutines.launch

class AuthorizeFragment : Fragment() {
    private lateinit var dependencyContainer: ApplicationDependencyContainer
    private val activityViewModel: com.example.walletapidemo.ui.AuthorizeViewModel by activityViewModels()
