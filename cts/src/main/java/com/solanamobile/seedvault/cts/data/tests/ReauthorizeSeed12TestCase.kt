...
internal open class ReauthorizeSeed12TestCase @Inject constructor(
    ...
    private suspend fun testReauthorizeSeed(): Boolean {
        @AuthToken val preAuthorizeAuthToken = knownSeed12NotAuthorizedChecker.findMatchingSeed()
        ...
        @AuthToken val postAuthorizeAuthToken = knownSeed12NotAuthorizedChecker.findMatchingSeed()
